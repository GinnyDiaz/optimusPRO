...
<head>
    ...
    <!--START SCRIPT-->
    <script type="text/javascript" src="<?php echo PROJECT_NAME; ?>js/chainSupply.js"></script>
    <script type="text/javascript" src="<?php echo PROJECT_NAME; ?>js/procesos.js"></script>
    <script type="text/javascript" src="<?php echo PROJECT_NAME; ?>js/actividades.js"></script>    
    <!--END SCRIPT-->
    ...
    <script src="<?php echo PROJECT_NAME; ?>components/jquery/dist/jquery.js"></script>
