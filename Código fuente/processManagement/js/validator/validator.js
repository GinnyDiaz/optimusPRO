...
var validator = (function($){
	...
	*/
	message = {
		...
		empty			: 'Debe completar el campo',
		min				: 'Valor demasiado corto ',
		max				: 'Valor demasiado largo ',
		number_min		: 'Número inferior al mínimo',
		number_max		: 'Número superior al máximo',
		url				: 'URL inválida',
		number			: 'Solo se permite números',
		email			: 'El email es inválido',
		email_repeat	: 'Los email no coinciden',
		password_repeat	: 'Contraseñas no coinciden',
		repeat			: 'Los valores no coinciden',
		complete		: 'El valor no está completo',
	...
	tests = {
		...
		text : function(a){
			...
			if( lengthRange && a.length < lengthRange[0] ){
				alertTxt = message.min+'(min:'+lengthRange[0]+')';
				return false;
			}

			// check if there is max length & field length is greater than the allowed
			if( lengthRange && lengthRange[1] && a.length > lengthRange[1] ){
				alertTxt = message.max+'(max:'+lengthRange[1]+')';
				return false;
			}
